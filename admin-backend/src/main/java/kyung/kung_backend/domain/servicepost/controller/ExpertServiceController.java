...
@Tag(name = "Expert Service", description = "고수 서비스 관련 API")
@RestController
...
public class ExpertServiceController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ExpertServiceResponse>> createExpertService(
            @AuthenticationPrincipal User user,
            @RequestBody ExpertServiceCreateRequest request
    ) {

        ExpertServiceResponse response =
                expertServicePostService.createExpertService(user, request);
    ...
    public ResponseEntity<ApiResponse<ExpertServiceResponse>> getExpertServiceDetail(
            @PathVariable Long serviceId
    ) {

        ExpertServiceResponse response =
                expertServicePostService.getExpertServiceDetail(serviceId);
